...
Baseline measured 2026-07-29 across 8 files, 99 blocks, 140 sentences.

## Per threshold

| threshold | basis | derivation |
| --- | --- | --- |
| `sentence_max_words = 25` | external | Plain-language consensus: average 15–20, maximum 25. This repo measured mean 21.7, median 18 — in band, with a long tail. |
